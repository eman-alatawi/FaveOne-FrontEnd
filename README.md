...
- Various improvements in the UI.
  ...
  -  A clickable Dialog about the Movie/Drama Info when trying to add a new Image Gallery or edit an existing one. [The dialog contains basic information and a list of related image galleries]
## Important Links
...
<img src="https://drive.google.com/uc?export=view&id=12gw_-UzKaRmuj6eHhFjRLhESHNaITQPd" width="400">
