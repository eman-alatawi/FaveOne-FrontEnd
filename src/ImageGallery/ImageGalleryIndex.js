...
export default class ImageGalleryIndex extends Component {
  ...
  editImageGallery = (imageGallery) => {
    ...
    axios
      .put("/favone/imagegallery/edit", imageGallery, {
        headers: {
      ...
      .catch((error) => {
        ...
        console.log(error);
        toast.error(
          "Error Occured while trying to Edit the Image Gallery. Please try again later"
        );
      });
  };
  ...
  deleteImageGallery = (id) => {
    ...
    axios
      .delete("/favone/imagegallery/delete", {
        params: { id: id },
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
        },
            ...
            <div key={index}>
              {this.state.isEdit &&
                ...
                <EditImageGallery
                  ...
                  editView={this.editView}
                  loadImageGalleries={this.props.loadImageGalleries}
                  moviesDramas={this.props.moviesDramas}
                  editImageGallery={this.editImageGallery}
                ></EditImageGallery>
              ) : null}
            </div>
          ))}
